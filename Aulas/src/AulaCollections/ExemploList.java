...
public class ExemploList {
    public static void main(String[] args) {
        ...
        System.out.println("Exiba a soma dos valores: " + soma); // A resposta deste está na logica acima com o Iterator//
        System.out.println("Exiba a média das notas: " + soma/notas.size()); //o método size retorna a quantidade de valores que contem na lista de notas//
        System.out.println("Remova a nota 0 " + notas.remove(6));
        System.out.println(notas.toString());
